 ...
 * - Keine Daten über den möglichen laden
 */
...

		{
			...
			components: [
				...
				{kind: "onyx.Groupbox", components: [
					{kind: "onyx.GroupboxHeader", content: "Preiseinstellungen"},
					{style:"width: 100%; margin-bottom: 1em;padding: 4px;", kind: "Select", onchange: "setPrices", selected: conf.displayStudentPrices(), components: [
				...
				{kind: "onyx.Groupbox", components: [
					{kind: "onyx.GroupboxHeader", content: "Zu ladene Mensen"},
					{kind: "Scroller", name: "availableMensen", style:"height: 200px", horizontal: "hidden", classes: "enyo-fi2t list enyo-unselectable", ondragfinish: "preventDragTap"}
				]},
...
//		this.body.className = bool ? "loading" : "";
