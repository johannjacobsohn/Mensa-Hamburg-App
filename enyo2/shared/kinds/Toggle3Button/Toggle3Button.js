/**
	...
	three states. Each time a ToggleButton is tapped, it switches its value and
	fires an _onChange_ event.

		{kind: "onyx.ToggleButton", onContent: "foo", offContent: "bar",
			neutralContent: "baz", onChange: "buttonToggle"},
...
enyo.kind({
	...
	published: {
		...
		offContent: "Off",
		//* Label for toggle button's "neutral" state
		neutralContent: "Off",
