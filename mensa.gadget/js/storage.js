...
//					window.prompt("1",datefield)

					germanStartdate = datefield.split("-")[0];
//					window.prompt("2","")
						germanStartdateArr = germanStartdate.split(".");//trim() -> IE7 
//					window.prompt("3	","")
						startdate = new Date(germanStartdateArr[2],(germanStartdateArr[1]-1),germanStartdateArr[0]);
//					window.prompt("trs"," 	"+trs.length + "")
...
//						window.prompt("for","the windows"+p.length)
...
//						window.prompt("for","the windows 7")
...
//							window.prompt("dish",dish)
						...
						window.prompt(storage.lock[additional_args.mensaName],"lock removed ?")
						
						// try to run callbacks
						storage.runMenuCallbacks();
						
						window.prompt("callbacks","")
						
					}, function(resp, additional_args){
					
						window.prompt("xhr error","")
