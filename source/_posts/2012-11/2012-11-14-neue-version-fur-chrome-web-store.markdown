---
layout: post
title: "Neue Version für Chrome Web Store"
date: 2012-11-14 20:47
comments: true
categories: chrome update tablet tablet-2.0
---

<figure class="left">
	<a href="{{page.url}}">
		{% img /assets/release/tablet-2.0/chrome/ui-small.png %}
	</a>
</figure> 

Endlich ein neue Version der Chrome App. Schneller, schöner, anpassbarer!
...
<figure>
	{% img /assets/release/tablet-2.0/chrome/ui.png %}
...
schöner, deutlich flüssiger, viel schneller und - in Zeiten von riesen 
Telefonen und winzigen Tablets nicht unwichtig, sehr viel anpassbarer an die 
Fenster.  Zudem sind die einzelnen Filterleisten zu- und abschaltbar, so 
dass man nur sehen muss, was man braucht. Dies bedeutet auch das die App 
deutlich bequemer als Seitenleiste u.Ä. zu nutzen ist.

<figure>
	{% img /assets/release/tablet-2.0/chrome/portrait.png  %}
	<figcaption>Kleines Fenster abgeschalteten Filtern</figcaption>
</figure> 

Neues App-Icon
---
<figure>
	{% img /assets/release/tablet-2.0/chrome/icons.png  %}
	<figcaption>Oben rechts das neue, daneben das alte Logo</figcaption>
</figure> 
...
<figure>
	{% img /assets/release/tablet-2.0/chrome/filter.png  %}
...
<figure>
	{% img /assets/release/tablet-2.0/chrome/set-filter.png  %}
...
<figure class="right" style="max-width: 60%;">
	{% img /assets/release/tablet-2.0/chrome/details.png  %}
	<figcaption>Details für einzelne Gerichte gibts auf Anklicken</figcaption>
</figure> 
