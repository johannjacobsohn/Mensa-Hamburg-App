...
enyo.path.addPaths({onyx: "../source/../lib/onyx/", onyx: "../source/../lib/onyx/source/", layout: "/home/jjacobsohn/git/mensaApp/enyo2/phone/enyo/tools/../../lib/layout/", Carousels: "../source/Carousels/"});
...
"use strict";
var e = {}, t = function(t) {
return typeof e[t] != "undefined" ? e[t] : localStorage.getItem(t);
}, n = function(t, n) {
...
}) || f[e].push(t) : console.warn("event '" + e + "' does not exist"), this;
}, c = function(e, t) {
var n = 0;
...
e === "date" && (r = nt(t.sort()[t.length - 1].value)), v[e] = e, m[e] = t, y();
}, T = function(e) {
...
for (var s in u) if (u.hasOwnProperty(s)) for (var o in u[s]) u[s].hasOwnProperty(o) && (u[s][o] = e.some(function(e) {
return s === e.mensa && parseInt(o, 10) === e.week;
}));
return T("mensa"), _(), this;
}, L = function(t, n) {
n = n || r.getWeek();
...
function p(t, n) {
var r = n.mensa, i = n.week, a = O(t, r, i);
a && a.length > 0 && (e = e.filter(function(e) {
return e.week !== i || e.mensa !== r;
}), e = e.concat(a), u[r][i] = !0, o = !0), delete s[n.mensa + n.week], M();
}
function d(e, t) {
console.error("xhr error"), delete s[t.mensa + t.week], M();
}
var a = conf.getSavedURLs(), f = "", l = (new Date).getWeek(), c = "";
t = t || r.getWeek();
for (var h = 0; h < a.length; h++) f = a[h], u[f] = u[f] || {}, (!u[f][t] || i) && !s[f + t] && (t === l || t === l + 1) && (n = !1, s[f + t] = !0, c = urls.mensenWeek[f].replace(/\{\{week\}\}/, t), xhr.get(c, p, d, {
mensa: f,
week: t
}));
M();
...
content: n,
name: n,
filtered: typeof m.name != "undefined" && m.name.some(function(e) {
return e.value === n;
}),
filter: m.name ? m.name.filter(function(e) {
return e.value === n;
})[0] : []
});
t(i);
...
while (o--) for (var u = 0; u < e[o][t].length; u++) i[e[o][t][u]] = !0;
...
filter: m[t] ? m[t].filter(function(e) {
return e.value === r;
})[0] : []
});
n(s);
...
return e === "date" ? U(t) : e === "mensa" ? R(t) : e === "name" ? j(t) : e === "additives" ? q(t) : e === "properties" && I(t), this;
}, W = function(e) {
var t = e ? 12 : 5, n = new Date, r = n.setDate(n.getDate() - (n.getDay() + 6) % 7), i = [];
for (var s = 0; s < t; s++) s !== 5 && s !== 6 && (n = new Date(r.valueOf() + s * 3600 * 24 * 1e3), i.push(tt(n)));
return i;
}, X = function(e, t) {
t = typeof t == "undefined" ? !0 : t, r.setHours(0), r.setMinutes(0), r.setSeconds(0), r.setMilliseconds(0), r.getDay() === 6 ? r.setDate(r.getDate() + 2) : r.getDay() === 0 && r.setDate(r.getDate() + 1), K(r, t, e);
}, V = function(e, t) {
r = new Date, r.setHours(0), r.setMinutes(0), r.setSeconds(0), r.setMilliseconds(0), t = typeof t == "undefined" ? !0 : t, r.getDay() === 6 ? r.setDate(r.getDate() + 2) : r.getDay() === 0 && r.setDate(r.getDate() + 1), K(r, t, e);
}, $ = function(e, t) {
var n = r.getDay();
return t = typeof t == "undefined" ? !0 : t, n === 5 ? r.setDate(r.getDate() + 3) : r.setDate(r.getDate() + 1), K(r, t, e), this;
}, J = function(e, t) {
var n = r.getDay();
t = typeof t == "undefined" ? !0 : t, n === 1 ? r.setDate(r.getDate() - 3) : r.setDate(r.getDate() - 1), K(r, t, e);
}, K = function(e, t, n) {
x("date", tt(e)), t ? C(function(t) {
n(t, tt(e), e);
}) : w(function(t) {
n(t, tt(e), e);
});
...
return t === 1 ? e.setDate(e.getDate() - 3) : e.setDate(e.getDate() - 1), W(!0).indexOf(tt(e)) !== -1;
}, G = function() {
var e = new Date(r.valueOf()), t = r.getDay();
return t === 5 ? e.setDate(r.getDate() + 3) : e.setDate(r.getDate() + 1), W(!0).indexOf(tt(e)) !== -1;
}, Y = function() {
var e = (new Date).getWeek();
A(e, !0), A(e + 1, !0);
}, Z = new Date, et = function() {
var e = new Date, t = 864e5;
e - Z > t && (Y(), Z = e), setTimeout(et, 36e5);
}, tt = function(e) {
...
filter: w,
isNextDayAvailable: G,
isPrevDayAvailable: Q,
thisDay: X,
nextDay: $,
prevDay: J,
today: V,
...
create: function() {
this.inherited(arguments), this.setCaption(this.caption);
},
setCaption: function(e) {
this.caption = e, this.$.caption.setContent(e);
}
});
...
var t = new Date(this.date + e * 1e3 * 60 * 60 * 24), n = storage.dateToDateString(t);
return this.availableDates.indexOf(n) !== -1;
},
getView: function(e) {
var t = this.date + e * 1e3 * 60 * 60 * 24;
return {
kind: "menuList",
index: e,
date: new Date(t)
...
var n = this.index;
t.snap && this.index--;
var r = new Date(this.date + this.index * 1e3 * 60 * 60 * 24);
return r.getDay() == 1 && (this.index = this.index - 2), this.dateIsAvailable(this.index - 1) ? (this.$.carousel.newView(t.originator, this.getView(this.index - 1)), !0) : (this.index = n, !1);
},
getRight: function(e, t) {
var n = this.index;
t.snap && this.index++;
var r = new Date(this.date + this.index * 1e3 * 60 * 60 * 24);
return r.getDay() == 5 && (this.index = this.index + 2), this.dateIsAvailable(this.index + 1) ? (this.$.carousel.newView(t.originator, this.getView(this.index + 1)), !0) : (this.index = n, !1);
},
loading: function(e) {
var t = 100, n = 1e3, r = this;
this.timer && !e ? (this.showloadingMessage(!1), this.showloadingSpinner(!1), clearTimeout(this.timer), clearTimeout(this.long_timer), delete this.timer, delete this.long_timer) : e && typeof this.timer != "number" && (this.timer = setTimeout(function() {
r.showloadingMessage(!0);
}, t), this.long_timer = setTimeout(function() {
r.showloadingSpinner(!0);
}, n));
},
...
today: function(e, t) {
this.index = 0, this.$.carousel.setCenterView(this.getView(this.index));
},
yesterday: function() {
...
var n = t.index, r = this.menu[n], i = t.item.$.menuItem, s = t.item.$.divider;
r.type === "header" ? (i.destroy(), s.setCaption(r.header)) : (s.destroy(), i.setMenuItem(r));
},
create: function(e, t) {
this.inherited(arguments), this.setHeader(), this.load();
},
setHeader: function() {
this.$.header.setContent(formatDate(this.date)), this.$.header.render();
},
today: function() {
...
load: function() {
var e = "day", t = this;
return storage[e](this.date, !0, function(e, n) {
t.menu = e, t.$.menu.setCount(e.length);
}), this;
}
});
...
return n.l !== e;
}), t.value && n.label && this.savedMensen.push(n.label), !0;
},
setupRow: function(e, t) {
var n = t.index, r = this.availableMensen[n];
console.log(this.mensaInfo[n].active), t.item.$.toggleItem.label = r.name, t.item.$.toggleItem.value = this.mensaInfo[n].active, t.item.$.toggleItem.sublabel = r.address, t.item.$.toggleItem.render();
},
saveMensen: function(e) {
conf.setURLs(this.savedMensen), this.availableMensen = conf.getMensaInfo(), storage.cleanData(), enyo.Signals.send("onRequestMenu");
},
savedMensen: conf.getSavedURLs(),
mensaInfo: conf.getMensaInfo(),
availableMensen: urls.mensen,
setPrices: function(e) {
conf.setStudentPrices(e.children[e.selected].value);
},
load: function() {},
create: function() {
this.inherited(arguments), this.$.mensaList.setCount(this.availableMensen.length);
}
});
...
kind: "onyx.PickerDecorator",
onchange: "changePreserveFilters",
components: [ {}, {
kind: "onyx.Picker",
components: [ {
content: "Permanent",
...
console.log(e + "Filter", this.$, this.$[e + "Filter"]);
var t = this.$[e + "Filter"].getStatus();
return console.log(t), t.length === 0 ? storage.unsetFilter(e) : storage.setFilter(e, t), this;
},
load: function(e) {},
...
console.log("index", t.selected), t.selected.content === "Ja" ? n = "include" : t.selected.content === "Nein" ? n = "exclude" : n = "none", r.bubble("onChange", {
content: r.label,
state: n
});
}, 10);
...
if (typeof r == "undefined" || typeof n == "undefined") return;
return n !== "none" && console.log(n, r), n === "none" ? delete this.filteredBy[r] : this.filteredBy[r] = n, n !== "none" && console.log(this.filteredBy), !0;
},
activate: function() {
"use strict";
...
"use strict";
var n = t.index, r = this.cache[n], i = t.item.$.yESNOitem;
i.label = r.content, i.value = r.filtered, i.load();
},
load: function() {
"use strict";
var e = this;
storage.getInfo(this.type, function(t) {
console.log(t), e.cache = t, e.$.repeater.setCount(t.length);
});
},
getStatus: function() {
"use strict";
...
for (t in this.filteredBy) this.filteredBy.hasOwnProperty(t) && e.push({
value: t,
type: this.filteredBy[t]
});
return console.log("getStatus", e), e;
},
create: function() {
this.inherited(arguments), this.$.header.setContent(this.title), this.load();
}
});
...
this.$.toggle.setValue(e), this.$.label.setContent(t);
},
toggleItemClick: function(e) {
this.$.toggle.setValue(!this.$.toggle.getValue());
var t = this.parent.parent.children.length;
try {
if (this.$.label.getContent() === "Alle") for (var n = 1; n < t; n++) this.parent.parent.children[n].children[0].children[0].children[0].setValue(!0); else this.parent.parent.children[0].children[0].children[0].children[1].getContent() === "Alle" && this.parent.parent.children[0].children[0].children[0].children[0].setValue(!1);
} catch (r) {
console.log("catch");
}
}
...
tap: function() {
var e = this.$.moreInfo;
return e.setShowing(!e.showing), this.$.additives.setCount(this.data.additives.length), this.$.properties.setCount(this.data.properties.length), !0;
},
...
this.data = e, this.addRemoveClass("first", e.first), this.addRemoveClass("last", e.last), this.$.name.setContent(e.name), this.$.price.setContent((conf.displayStudentPrices() ? e.studPrice : e.normalPrice) + "\u20ac"), this.$.dish.setContent(e.dish), this.$.mensa.setContent(e.mensa);
}
});

// App.js

enyo.Scroller.touchScrolling = !enyo.Scroller.hasTouchScrolling(), enyo.platform.webos && window.PalmSystem.stageReady(), window.addEventListener("load", function() {
var e = (new App).renderInto(document.body);
conf.isConfigured() || (enyo.Signals.send("onRequestOpen", {
page: "settings"
}), e.showNotConfigured());
}, !1), enyo.kind({
name: "App",
...
this.$.panels.setIndex(t), this.$[e].load();
},
