...
enyo.path.addPaths({onyx: "/home/jjacobsohn/git/mensaApp/enyo2/tablet/enyo/../lib/onyx/", onyx: "/home/jjacobsohn/git/mensaApp/enyo2/tablet/enyo/../lib/onyx/source/", layout: "/home/jjacobsohn/git/mensaApp/enyo2/tablet/enyo/../lib/layout/", ToggleBar: "/home/jjacobsohn/git/mensaApp/enyo2/tablet/enyo/../lib/ToggleBar/", SelectorBar: "/home/jjacobsohn/git/mensaApp/enyo2/tablet/enyo/../lib/SelectorBar/"});
...
load: function() {
return this.$.list.setShowing(!1), this.$.spinner.show(), storage.getInfo(this.filter, function(e) {
...
load: function() {
this.$.menuList.setLoading(!0), storage.getSortedSegmented(function(e) {
this.$.menuList.setLoading(!1), this.$.menuList.menu = e, this.$.menuList.load(), this.reflow();
}.bind(this));
}
});
...
closePopup: function() {
this.$.panelPopup.setShowing(!1);
},
oldactivePanels: enyo.clone(this.activePanels),
activePanelsChanged: function() {
for (var e in this.activePanels) this.activePanels.hasOwnProperty(e) && this.activePanels[e] !== this.oldactivePanels[e] && (this.$[e].setShowing(this.activePanels[e]), this.activePanels[e] && this.$[e].load().reflow());
this.$.panels.reflow(), data.set("activePanels", JSON.stringify(this.activePanels)), this.oldactivePanels = enyo.clone(this.activePanels);
},
panelChange: function(e, t) {
this.activePanels[e.type] = t.value, this.activePanelsChanged();
},
changePanels: function() {
this.setPanelToggles(), this.$.panelPopup.setShowing(!0);
},
setPanelToggles: function() {
var e, t = this.getActivePanels();
for (e in t) t.hasOwnProperty(e) && (this.$[e + "Toggle"].value = t[e]);
this.setPanelToggles = function() {};
},
rendered: function() {
this.inherited(arguments), this.activePanelsChanged();
}
});
...
enyo.platform.webos ? location.href = info.releaseNotes.touchpad : enyo.platform.android || enyo.platform.androidChrome ? location.href = info.releaseNotes.androidTablet : enyo.platform.chrome ? location.href = info.releaseNotes.chrome : enyo.platform.ios && (location.href = info.releaseNotes.ipad);
},
